  ...
  <div class="buy-cart-container">
    ...
    <div class="cart-price fl">
      <div class="price">
        ...
        <i
          v-if="buyCartInfo.originalprice"
        >{{ buyCartInfo.originalprice }}</i>
      </div>
  ...
  <Modal :isOpen="isOpenRef" css-class="buy-cart-modal" @didDismiss="showBuyCart(false)">
    <div class="cart-foods">
      <div class="cart-title">
        ...
        <span>
          (包装费¥
          <span class="color">2.5</span>)
        </span>
        <span class="fr" @click="clearBuyCart">
          <ion-icon :src="trashOutline"></ion-icon>清空
        </span>
      </div>
      <ul>
...
//添加
const addBuyCarts = (event: MouseEvent, item: Food) => {
